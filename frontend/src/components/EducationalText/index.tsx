...
export const EducationalText = () => {
  return (
    <>
      ...
      <ol>
        <li>
          Look in <code>frontend/App.tsx</code> - you will see{" "}
          <code>getGreeting</code> and <code>setGreeting</code> being called on{" "}
          <code>contract</code>. What is this?
        </li>
        <li>
          Ultimately, this <code>contract</code> code is defined in{" "}
          <code>./contracts</code> – this is the source code for your{" "}
          <a
            target="_blank"
            rel="noreferrer"
        ...
        <li>
          When you run <code>yarn deploy</code>, the code in{" "}
          <code>./contracts</code> gets deployed to the NEAR testnet. You can
          see how this happens by looking in <code>package.json</code>.
        </li>
      </ol>
      <hr />
      <p>
